                ...
                <Box display={"flex"} mt={1} alignItems="center">
                  ...
                  <Box sx={style}>
                    <img
                      src={
                        clientContext?.theme?.nextJSImages
                          ? "https://facekiassets.faceki.com/public/kyc-verify/id_card_back.png"
                          : require("../assets/images/kyc-verify/id_card_back.png")
                              .default ||
                            require("../assets/images/kyc-verify/id_card_back.png")
                      }
                      width={50}
          ...
          <Box display={"flex"} mt={1} alignItems="center">
            ...
            <Box sx={style}>
              <img
                src={
                  clientContext?.theme?.nextJSImages
                    ? "https://facekiassets.faceki.com/public/kyc-verify/selfie.png"
                    : require("../assets/images/kyc-verify/selfie.png")
                        .default ||
                      require("../assets/images/kyc-verify/selfie.png")
                }
                width={50}
              ...
              <Typography ml={2}>Take a selfie picture</Typography>
            </Box>
          </Box>
        </Box>
        <Box mt={4}>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  style={{
                    color: agree
                      ? clientContext?.theme?.buttonbg || "#f8b427"
                      : undefined,
                  }}
                />
              }
              label={
                <Typography variant="body2">
                  ...
                  {clientContext?.theme?.externalTermsUrl && (
                    <a
                      style={{ marginLeft: 3 }}
                      href={clientContext?.theme?.externalTermsUrl}
                      target="_blank"
                    >
                      Terms & Conditions{" "}
                    </a>
